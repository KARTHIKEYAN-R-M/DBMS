...
<fieldset><legend>UPDATE FOOD ITEM...</legend><form action="a.jsp" method="post">
<input type="number" placeholder="enter id of the food item" name="ab"><br><br>
<input type="number" placeholder="enter price want to be updated" name="ac">
